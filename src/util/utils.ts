...
function isInputOrTextAreaElement(element?: HTMLElement): boolean {
  return element !== null && (element.nodeName.toUpperCase() === 'INPUT' ||
                              element.nodeName.toUpperCase() === 'TEXTAREA' || element.nodeName === '#text');
}
...
export class Highlighted {
  ...
  get clientRect(): DOMRect { return this.element.getBoundingClientRect(); }
}
