...
const EXPORT_DIRECTIVES = [NgxMentionsComponent, NgxMentionsInputDirective];
const DECLARATIONS = [NgxMentionsComponent, NgxMentionsInputDirective, MentionsListComponent, HighlightedDirective];
