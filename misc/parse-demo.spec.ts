...
describe(`Parse demo for StackBlitz`, () => {
  it('should extract a module name and a component selector', () => {
    expect(parseDemo('./misc/parse-demo-test-cases/simple/**/*.ts')).toEqual(
      new Map([
        [
  ...
  it('should extract multiple module names and component selectors', () => {
    expect(parseDemo('./misc/parse-demo-test-cases/multiple/**/*.ts')).toEqual(
      new Map([
        [
  ...
  it('should extract module name and component selector (strange formatting)', () => {
    expect(parseDemo('./misc/parse-demo-test-cases/syntax/**/*.ts')).toEqual(
      new Map([
        [
  ...
  it('should extract module name and component selector (oneliner definition)', () => {
    expect(parseDemo('./misc/parse-demo-test-cases/oneliner/**/*.ts')).toEqual(
      new Map([
        [
  ...
  it('should fail if there is no bootstrap component', () => {
    expect(() => {
      parseDemo('./misc/parse-demo-test-cases/no-bootstrap-component/**/*.ts');
    }).toThrowError(
