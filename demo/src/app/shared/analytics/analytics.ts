 ...
 * is deployed on ngx-mentions.github.io. This avoids sending events and page views during development.
 */
@Injectable()
export class Analytics {
    ...
    constructor(private _location: Location, private _router: Router) {
        this._enabled = window.location.href.indexOf('ngx-mentions.github.io') >= 0;
    }
