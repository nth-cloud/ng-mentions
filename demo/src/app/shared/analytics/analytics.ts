 ...
 * is deployed on nth-cloud.github.io/ngx-mentions. This avoids sending events and page views during development.
 */
@Injectable()
export class Analytics {
    ...
    constructor(private _location: Location, private _router: Router) {
        this._enabled = window.location.href.indexOf('nth-cloud.github.io/ngx-mentions') >= 0;
    }
